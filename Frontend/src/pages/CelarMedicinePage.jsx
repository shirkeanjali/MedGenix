...
// Celar 500mg medicine data
const medicineData = {
  id: 'celar-500mg',
  name: 'Celar',
  brand: 'Ranbaxy',
  category: 'Pain Reliever & Fever Reducer',
  usageInfo: "Celar (Paracetamol) is used to treat mild to moderate pain and reduce fever. It's commonly used for headaches, toothaches, backaches, menstrual cramps, muscular aches, and fevers related to colds and flu.",
  howItWorks: "Celar (Paracetamol) works by blocking the production of certain chemicals (prostaglandins) that cause pain and fever. It's believed to act centrally in the brain to reduce pain perception and at the hypothalamus to reduce fever.",
  activeIngredients: 'Each tablet contains Paracetamol 500mg.',
  sideEffects: [
    {
      severity: 'Common',
      effects: [
  ...
  genericId: 'paracetamol-500mg',
  price: 56.75,
  dosageOptions: [
    { strength: '500 mg', form: 'Tablet', price: 56.75 },
    { strength: '500 mg', form: 'Syrup', price: 75.50 },
    { strength: '650 mg', form: 'Tablet', price: 68.25 }
  ],
  patientTestimonials: [
    {
      name: 'Meera S.',
      age: 34,
      testimonial: 'I always keep Celar in my medicine cabinet. It works quickly to relieve my headaches without making me drowsy.',
      rating: 5
    },
    {
      name: 'Rahul M.',
      age: 42,
      testimonial: "It's effective for bringing down fever. I prefer this brand over others as it seems to cause less stomach discomfort for me.",
      rating: 4
    },
    {
      name: 'Priya D.',
      age: 29,
      testimonial: "Works well for my occasional migraines, but I wish it came in blister packs rather than bottles for better on-the-go use.",
      rating: 4
    }
  ]
};
...
export default CelarMedicinePage; 