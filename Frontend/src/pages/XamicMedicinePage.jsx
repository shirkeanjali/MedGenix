...
// Xamic 500mg medicine data
const medicineData = {
  id: 'xamic-500mg',
  name: 'Xamic',
  brand: 'Sun Pharma',
  category: 'Antifibrinolytic',
  usageInfo: 'Xamic (Tranexamic Acid) is used to prevent or reduce bleeding in various clinical situations, such as during or after surgery, in hemophilia, or for heavy menstrual bleeding. It works by slowing the breakdown of blood clots.',
  howItWorks: 'Xamic (Tranexamic Acid) works by blocking the breakdown of blood clots by inhibiting the activation of plasminogen to plasmin. This helps to stabilize formed clots and prevent excessive bleeding.',
  activeIngredients: 'Each tablet contains Tranexamic Acid 500mg.',
  sideEffects: [
    {
      severity: 'Common',
      effects: [
  ...
  genericId: 'tranexamic-acid-500mg',
  price: 245.30,
  dosageOptions: [
    { strength: '500 mg', form: 'Tablet', price: 245.30 },
    { strength: '500 mg', form: 'Injection', price: 325.75 },
    { strength: '250 mg', form: 'Tablet', price: 185.60 }
  ],
  patientTestimonials: [
    {
      name: 'Deepika R.',
      age: 32,
      testimonial: 'Xamic has been very effective in managing my heavy menstrual bleeding. My quality of life has improved significantly.',
      rating: 5
    },
    {
      name: 'Vikram T.',
      age: 45,
      testimonial: "I was prescribed this after dental surgery and it definitely reduced the bleeding. Had some mild nausea but overall it was worth it.",
      rating: 4
    },
    {
      name: 'Sunita L.',
      age: 38,
      testimonial: "Works well but I found the generic version to be equally effective and much more affordable.",
      rating: 3
    }
  ]
};
...
export default XamicMedicinePage; 